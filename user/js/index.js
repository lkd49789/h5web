...
//添加事件
	...
	function getOrderList(_type,_sale_id,_pay_amount){
		$.ajax({
            type: "POST",
            url: "https://pocketapi.48.cn/pay/api/v1/wx/mp/order/create",
            data: {
                "openid": openid,
                "sale_id": _sale_id,
                "userId": $(".pocketid").val(),
                "custom_price": _pay_amount
            },
            contentType: 'application/x-www-form-urlencoded',
            success: function(data){
                var wxmp = data.content.wxMp;
                onBridgeReady(wxmp.appId,wxmp.timeStamp, wxmp.nonceStr, wxmp.package, wxmp.paySign)
            }
        });
		// $.ajax({
		// 	type:'get',
