...
(function(data) {
    var user_id,user_name,user_pic,encryption,imei;
	  ...
	  if(isExitsFunction("window.web.getLoginUserId")){
       ...
       encryption = "HqPZsrfFYz2PYO/haQFqSWXNImnFgbddOX9tYQ/IEbyHUtpE5l6eX6XDre0h2R9GfmHmv8TTxFw/RmKzWyFyUVXr1/tUYTwb";
    }
...
// alert(encryption)
  ...
  data.topList = function(teamId,succ, error) {
    $.ajax({
      async: true, 
      crossDomain: true,
      url: CONFIG.getPath()+"mc/v1/topic/topList",
      type: "POST", 
      dataType: 'json', 
      data: {teamId:teamId},
      timeout: 5000, 
...
Vue.filter('AvataLock', function (id) {
  return "images/lock"+id+".png";
});
  //判断是否隐藏h5头部
