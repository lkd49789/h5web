...
H5UPLOAD.html5upload = (function ()
{
    ...
    function _init(_upload_holder)
    {
        ...
        _uploadEle.onclick = _onClick;
        _setStatusNoDrag();

        $("#fileToUpload").change(function(){
              var oFiles = document.querySelector("#fileToUpload").files;
    ...
    {   
        ...
        if (file.type.match(/image*/))
        {
            reader.onload = function (e)
            {
                ...
                img.css({'width':'100%','height':'100%','vertical-align':'middle','object-fit':'cover'});
