...
if(checkFromApp()) {
	$('.share-btn').on('click',function(){
		window.web.share("ALL","https://h5.48.cn/2018apppage/publicVote_news/img/thumb.jpg","https://h5.48.cn/2018apppage/publicVote_news/index.html","神秘怪盗重出江湖，夺下珍宝占据头号新闻！","快来选出SNH48 TEAM HII《头号新闻》你最喜欢的曲目吧！","https://h5.48.cn/admin/sharecount.php?title=publicVote_news",false);
	})
}else{
	$("#alltexts").attr('disabled','disabled');
	$(".likebtn").attr("disabled", true);
	
    var shareTitlestr="神秘怪盗重出江湖，夺下珍宝占据头号新闻！",
    	shareDesc="快来选出SNH48 TEAM HII《头号新闻》你最喜欢的曲目吧！",
    	shareLink="https://h5.48.cn/2018apppage/publicVote_news/index.html",
    	thumbLink="https://h5.48.cn/2018apppage/publicVote_news/img/thumb.jpg",
    	shareTitle="publicVote_news";
    wxshare();
