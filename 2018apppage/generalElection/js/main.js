(function(data) {
    ...
    data.getAllMembers = function(succ){
     ...
     //提交预测结果
    data.submit = function(arr,succ){
        $.ajax({
            url:CONFIG.getUerlink()+"api/zxGuess/v1/saveGuess",
            type: "POST", 
...
//               alert("eee");
    ...
    //分享日榜列表
    data.getMyrank = function(succ){
        $.ajax({
            url:CONFIG.getUerlink()+"api/supportActivity/v1/dayRank",
            type: "POST", 
            contentType: "application/json; charset=utf-8",
             beforeSend: function (request) {
                request.setRequestHeader("token", main.getAppUserInfo().apptoken);
...
//               alert("eee");
    ...
    data.getGuessmsg = function(succ){
        $.ajax({
            url:CONFIG.getUerlink()+"api/zxGuess/v1/getGuess",
            type: "POST", 
            contentType: "application/json; charset=utf-8",
             beforeSend: function (request) {
                request.setRequestHeader("token", main.getAppUserInfo().apptoken);
