...
if(checkFromApp()) {
	$('.share-btn').on('click',function(){
		window.web.share("ALL","https://h5.48.cn/2018apppage/publicVote_fighter_end/img/thumb.jpg","https://h5.48.cn/2018apppage/publicVote_fighter_end/index.html","不死鸟的不死战魂，BEJ48 TEAM B唱响激燃的旋律！","最受欢迎的BEJ48 TEAM B《B A FIGHTER》公演曲目，都在这里了！","https://h5.48.cn/admin/sharecount.php?title=publicVote_fighter_end",false);
	})
}else{
	$("#alltexts").attr('disabled','disabled');
	$(".likebtn").attr("disabled", true);
	
    var shareTitlestr="不死鸟的不死战魂，BEJ48 TEAM B唱响激燃的旋律！",
    	shareDesc="最受欢迎的BEJ48 TEAM B《B A FIGHTER》公演曲目，都在这里了！",
    	shareLink="https://h5.48.cn/2018apppage/publicVote_fighter_end/index.html",
    	thumbLink="https://h5.48.cn/2018apppage/publicVote_fighter_end/img/thumb.jpg",
    	shareTitle="publicVote_fighter_end";
    wxshare();
