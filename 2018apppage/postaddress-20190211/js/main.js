(function(data) {
    ...
    var webUserInfo = {
        //"appid":"87333",                                //用户ID
       // "apptoken":"Ijtlu+LSg7o6U/0RA4k4zWMnf66NGl3Uj6NbzaD0NJNz4ddUN3JDvDpJ1bcWg3n3",                          //验证Token
        //"uname":"嘟嘟宝",                                 //用户昵称
    ...
    //绑定收货地址
    data.bindAddress = function(_obj,_addressId,_security,succ){
        var addressObj = {
            token:main.getAppUserInfo().apptoken,
            addressId:_addressId,
            security:_security
        }
        var allPara = Object.assign({},_obj,addressObj);
        console.log(JSON.stringify(allPara))
        $.ajax({
            url:  "https://snhwxapi.48.cn/fans/api/v1/xm/guess/awards/address",
            type: "POST", 
            async:true,
            contentType: "application/json; charset=utf-8",
            /*beforeSend: function (request) {
