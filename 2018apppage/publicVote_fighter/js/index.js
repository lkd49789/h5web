...
if(checkFromApp()) {
	$('.share-btn').on('click',function(){
		window.web.share("ALL","https://h5.48.cn/2018apppage/publicVote_fighter/img/thumb.jpg","https://h5.48.cn/2018apppage/publicVote_fighter/index.html","不死鸟的不死战魂，什么样的旋律，最能激扬斗志？","来为你心中最棒的BEJ48 TEAM B《B A FIGHTER》公演曲目投票吧！","https://h5.48.cn/admin/sharecount.php?title=publicVote_fighter",false);
	})
}else{
	$("#alltexts").attr('disabled','disabled');
	$(".likebtn").attr("disabled", true);
	
    var shareTitlestr="不死鸟的不死战魂，什么样的旋律，最能激扬斗志？",
    	shareDesc="来为你心中最棒的BEJ48 TEAM B《B A FIGHTER》公演曲目投票吧！",
    	shareLink="https://h5.48.cn/2018apppage/publicVote_fighter/index.html",
    	thumbLink="https://h5.48.cn/2018apppage/publicVote_fighter/img/thumb.jpg",
    	shareTitle="publicVote_fighter";
    wxshare();
