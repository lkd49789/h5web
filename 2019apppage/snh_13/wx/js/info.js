...
$(function(){
    ...
    $('#submit_btn').click(function () {
        ...
        //   return false;
        // }
        if ($('input[name=area1]:checked').val()== "" || $('input[name=area1]:checked').val()== undefined || $('input[name=area1]:checked').val()== "undefined"){
          ShowMsg('请选择复试城市！');
          return false;
        }
        if ($('input[name=resident1]:checked').val()== "" || $('input[name=resident1]:checked').val()==undefined  || $('input[name=resident1]:checked').val()== "undefined"){
          ShowMsg('请选择优选报名所属！');
          return false;
        }
