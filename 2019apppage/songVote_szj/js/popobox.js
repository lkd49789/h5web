Vue.component('popbox',{
    ...
    template:'<div v-cloak class="mask" v-if="showpop != 0" @touchmove.prevent>'+
        ...
        '<div class="no-money" v-if="showpop == 1">'+
            '<p><b>{{tips}}</b></p>'+
            '<span :style="\'background:url(\'+bg.imgUrl+\') no-repeat 0 0/100% 100%;background:\'+bg.bgColor+\';\'"  @click="showpop = 0">知道了</span>'+
            '</div>'+
