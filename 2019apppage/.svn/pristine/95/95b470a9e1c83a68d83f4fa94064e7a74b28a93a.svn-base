(function(data) {
    ...
    var webUserInfo = {
        ...
        "apptoken":"1",                          //验证Token
        "uname":"测试",                                 //用户昵称
        "avata":"https://wx.qlogo.cn/mmopen/vi_32/YOGtTgic3zLev1kN6T2e5LCMWER0BxopGLHQibM6JNyZNZuzoqunMC9A55oCZCvicic5Y8OiaibdRlTgQr0xIBQeia52g/132",                                    //头像地址
        "dev_cd":"1"                        //设备号
    }
    ...
    data.getToken = function(){
        if(checkFromApp()){
            ...
            return "He8l8b0XVL55guu5cvq4gTBwO4y6jV2dTgLG0U4YBXQX39pKKzoiUA=="
        }
    ...
    //所有成员
    data.botMemberInfo = function(succ){
        $.ajax({
            url:  CONFIG.getLink()+"api/activity/bot/v1/botMemberInfo",
            type: "POST", 
            async:true,
...
//               alert("eee");
    ...
    //提交留言
    data.saveComment = function(_comment,_memberId,succ){
        $.ajax({
            url:  CONFIG.getLink()+"api/activity/bot/v1/saveComment",
            type: "POST", 
            async:true,
            contentType: "application/json; charset=utf-8",
            beforeSend: function (request) {
...
//               alert("eee");
    ...
    //最新留言/留言排行
    data.commentInfo = function(_ctime,_limit,_place,succ){
        $.ajax({
            url:  CONFIG.getLink()+"api/activity/bot/v1/CommentInfo",
            type: "POST", 
            async:true,
            contentType: "application/json; charset=utf-8",
            beforeSend: function (request) {
            ...
            data: JSON.stringify({
                "ctime": _ctime,//分页参数 首页传0
                "limit": _limit,//分页数 默认20
                "place": _place//1-最新留言列表 2-留言排行
            }),
            timeout: 15000, 
            dataType:"json",
            success: function (data) { 
...
//               alert("eee");
    ...
    //成员留言排名/成员稿件排名
    data.memberRank = function(_palce,succ){
        $.ajax({
            url:  CONFIG.getLink()+"api/activity/bot/v1/memberRank",
            type: "POST", 
            async:true,
            contentType: "application/json; charset=utf-8",
            beforeSend: function (request) {
...
//               alert("eee");
    ...
    //最新投稿/投稿热度排名
    data.materialInfo = function(_ctime,_limit,_place,succ){
        $.ajax({
            url:  CONFIG.getLink()+"api/activity/bot/v1/materialInfo",
            type: "POST", 
            async:true,
            contentType: "application/json; charset=utf-8",
            beforeSend: function (request) {
...
//               alert("eee");
    ...
    //成员个人留言板
    data.memberComment = function(_ctime,_limit,_memberId,succ){
        $.ajax({
            url:  CONFIG.getLink()+"api/activity/bot/v1/memberComment",
            type: "POST", 
            async:true,
            contentType: "application/json; charset=utf-8",
            beforeSend: function (request) {
...
//               alert("eee");
    ...
    //留言点赞
    data.like = function(_commentId,succ){
        $.ajax({
            url:  CONFIG.getLink()+"api/activity/bot/v1/praise",
            type: "POST", 
            async:true,
            contentType: "application/json; charset=utf-8",
            beforeSend: function (request) {
...
//               alert("eee");
    ...
    //成员个人稿件
    data.membertg = function(_ctime,_limit,_memberId,succ){
        $.ajax({
            url:  CONFIG.getLink()+"api/activity/bot/v1/memberMaterial",
            type: "POST", 
            async:true,
            contentType: "application/json; charset=utf-8",
            beforeSend: function (request) {
