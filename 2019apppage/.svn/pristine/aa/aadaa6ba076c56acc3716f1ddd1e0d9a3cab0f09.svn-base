...
(function(data) {
    ...
    //var URL_PATH = "https://h5.48.cn/2019apppage/sports48/"    //项目地址
    
    //测试
    var LINK_URL = "http://192.168.0.22:8094/app-activity/";
    var URL_PATH = "http://192.168.0.9/2019apppage/handshakeonline/"                       //项目地址
